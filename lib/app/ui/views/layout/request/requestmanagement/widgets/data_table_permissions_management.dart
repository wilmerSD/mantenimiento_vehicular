...
class DataTablePermissionManagement extends StatelessWidget {
  const DataTablePermissionManagement({Key? key}) : super(key: key);
                            ...
                            return CustomRow(
                              cells: [
                                ...
                                CustomCell(item.fechaPermiso != null
                                    ? DateFormat('dd-MM-yyyy').format(
                                        DateTime.parse(item.fechaPermiso!
                                            .substring(0, 10)))
                                    : ''),
                                CustomCell('',
                                    isText: false,
                                                    ...
                                                    onTap: () {
                                                      Get.dialog(
                                                          AlertDialogComponent(
                                                              headerTitle:
                                                                  "¿Está seguro de aceptar el permiso?",
                                                              /* title:
                                                                  "Confirmar aceptación del permiso", */
                                                              onTapButton:
                                                                  () async {
                                                                /* print('press'); */
                                                                List<int>
                                                                ...
                                                                controller.updateStateOfRequest(
                                                                    2, false,
                                                                    idRequest:
                                                                        idRequestItem);
                                                                Get.back();
                                                  ...
                                                  IconWrapper(
                                                    onTap: () {
                                                      Get.dialog(
                                                          AlertDialogComponent(
                                                              headerTitle:
                                                                  "¿Está seguro de rechazar el permiso?",
                                                              /* title:
                                                                  "Confirmar rechazo del permiso", */
                                                              onTapButton:
                                                                  () async {
                                                                List<int>
                                                                    idRequestItem =
