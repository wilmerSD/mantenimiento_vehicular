...
import 'package:app_valtx_asistencia/app/ui/views/layout/maintainers/typesvalidation/widgets/edit_typesvalidation.dart';
...
class DataTableTypeValidation extends StatelessWidget {
  const DataTableTypeValidation({Key? key}) : super(key: key);
                ...
                Expanded(
                  child: TablePrimary(
                    ...
                    rows: List<CustomRow>.generate(
                      controller.listTypesValidation.length,
                      (index) {
                        final item = controller.listTypesValidation[index];
                        return CustomRow(
                          cells: [
                            CustomCell(
                              item.descripcion ?? '',
