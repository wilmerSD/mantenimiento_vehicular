...
class EditTypeValidation extends StatelessWidget {
  const EditTypeValidation({Key? key}) : super(key: key);
    ...
    return GetBuilder<TypeValidationController>(
        ...
        builder: (controller) {
          ...
          Widget inputTypeMarking = InputPrimary(
            ...
            maxLength: 35,
            textEditingController: controller.descriptionTypeValidation,
            validator: (value) {
          ...
          Widget btnSave = BtnPrimary(
              ...
              onTap: () {
                if (keyForm.currentState!.validate()) {
                  controller.updateTypesValidation();
                  Get.back();
                }
                /* controller.updateTypesValidation();
                Get.back(); */
              ...
              ? Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Editar tipo de validación",
