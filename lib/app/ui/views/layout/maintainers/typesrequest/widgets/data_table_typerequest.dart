...
import 'package:app_valtx_asistencia/app/ui/views/layout/maintainers/typesrequest/widgets/edit_typerequest.dart';
...
class DataTableTypeRequest extends StatelessWidget {
  const DataTableTypeRequest({Key? key}) : super(key: key);
                ...
                Expanded(
                  child: TablePrimary(
                    ...
                    rows: List<CustomRow>.generate(
                      controller.listTypesRequest.length,
                      (index) {
                        final item = controller.listTypesRequest[index];
                        return CustomRow(
                          cells: [
                            CustomCell(
                              item.descripcion ?? '',
