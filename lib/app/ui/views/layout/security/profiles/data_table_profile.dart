...
import 'package:app_valtx_asistencia/app/ui/views/layout/maintainers/workmodality/widgets/edit_workmodality.dart';
import 'package:app_valtx_asistencia/app/ui/views/layout/maintainers/workmodality/workmodality_controller.dart';
import 'package:app_valtx_asistencia/app/ui/views/layout/security/profiles/edit_profiles.dart';
...
class DataTableProfile extends StatelessWidget {
  const DataTableProfile({Key? key}) : super(key: key);
              ...
              children: [
                Expanded(
                  child: TablePrimary(
                    ...
                    columns: [
                      CustomColumn("Nombre de perfil",
                          columnSize: ColumnSize.S, isCenter: true),
                      CustomColumn("Descripción de perfil",
                          columnSize: ColumnSize.S, isCenter: true),
                      CustomColumn("Estado",
                          columnSize: ColumnSize.S, isCenter: true),
                      CustomColumn(
                    ...
                    rows: List<CustomRow>.generate(
                      /* controller.listModalityWork.length, */
                      1,
                      (index) {
                        /* final item = controller.listModalityWork[index]; */
                        return CustomRow(
                          cells: [
                            CustomCell("ADMIN"),
                            CustomCell("Administrador con acceso a todos los modulos"),
                            CustomCell('',
                            isText: false,
                            child: Container(
