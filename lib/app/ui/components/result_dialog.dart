      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: AppTextStyle(context)
                  .bold24(/* size: 19.2, */ color: AppColors.grayBlue),
          ...
          SizedBox(
            ...
            child: Text(
              subTitle,
              style: AppTextStyle(context).bold14(color: AppColors.blueDark),
              textAlign: TextAlign.center,
            ),
          ),
          const SizedBox(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          ...
                          borderColor: borderColor ?? AppColors.blueCustom,
                          textColor: textColor ?? AppColors.blueCustom,
                          onTap: onTapCancel,
                        )),
                        const SizedBox(
                          width: 10.0,
